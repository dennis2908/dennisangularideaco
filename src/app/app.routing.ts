...
if (localStorage.getItem("angularJS") === null) {
		...
		arrRoute = getRouteLogin();
	}
else if(Object.keys(JSON.parse(localStorage.getItem("angularJS"))).length === 0) {
 console.log(132113223,localStorage.getItem("angularJS"));
	arrRoute = getRouteLogin();
}	
else {
